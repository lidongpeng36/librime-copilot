...
VAULTED_FILES = (
    ...
    # Generated by `rime-copilot wordhead` from the corpus, vaulted for the
    # reason personal.dict.yaml is: regenerating needs the corpus to be HERE,
    # not merely synced. Unlike that file its absence degrades rather than
    # breaks -- the plugin logs a warning and runs without the prior -- but a
    # second machine silently typing without it is still the silent-fallback
    # shape, and `status` names it.
    "private/wordhead.txt",
